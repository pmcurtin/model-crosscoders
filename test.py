...
model_a = HookedTransformer.from_pretrained(model_a_str, tokenizer=tokenizer_a, device="cpu")
for param in model_a.parameters():
    param.requires_grad = False
model_b = HookedTransformer.from_pretrained(model_b_str, tokenizer=tokenizer_b, device="cpu")
